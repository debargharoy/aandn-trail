...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="#hero">Welcome</a></li>
          <li><a href="#about">Plan Your Trip</a></li>
  ...
  <section id="hero">
    <div class="hero-container">
      <h1>Emerald, Blue & You</h1>
      <h2>Andaman and Nicobar Islands Await Your Arrival!</h2>
